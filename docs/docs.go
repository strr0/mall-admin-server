...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/coupon/create": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "优惠券类型；0-\u003e全场赠券；1-\u003e会员赠券；2-\u003e购物赠券；3-\u003e注册赠券",
                        "name": "type",
                        "in": "query"
                    },
                    {
        ...
        "/flashProductRelation/list": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "flashPromotionId",
                        "name": "flashPromotionId",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "flashPromotionSessionId",
                        "name": "flashPromotionSessionId",
                        "in": "query"
                    },
                    {
        ...
        "/order/update/delivery": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "deliveryParamList",
                        "name": "deliveryParamList",
                        "in": "body",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.OmsOrderDeliveryDto"
                            }
                        }
                    }
                ],
        ...
        "/sku/update": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "skuStockList",
                        "name": "skuStockList",
                        "in": "body",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.PmsSkuStock"
                            }
                        }
                    }
                ],
    ...
    "definitions": {
        ...
        "model.CmsSubjectProductRelation": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "model.SmsCouponProductCategoryRelation": {
            "type": "object",
            "properties": {
                "couponId": {
                    "type": "integer"
        ...
        "model.SmsCouponProductRelation": {
            "type": "object",
            "properties": {
                "couponId": {
                    "type": "integer"
