...
func newPmsProductVertifyRecord(db *gorm.DB) pmsProductVertifyRecord {
	_pmsProductVertifyRecord := pmsProductVertifyRecord{}

	_pmsProductVertifyRecord.pmsProductVertifyRecordDo.UseDB(db)
	...
	_pmsProductVertifyRecord.ALL = field.NewField(tableName, "*")
...
type pmsProductVertifyRecord struct {
	pmsProductVertifyRecordDo

	ALL        field.Field
	ID         field.Int64
	ProductID  field.Int64
	CreateTime field.Time
	VertifyMan field.String
	Status     field.Int32
	Detail     field.String
...
func (p pmsProductVertifyRecordDo) Debug() *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Debug())
}

func (p pmsProductVertifyRecordDo) WithContext(ctx context.Context) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.WithContext(ctx))
}

func (p pmsProductVertifyRecordDo) ReadDB() *pmsProductVertifyRecordDo {
	return p.Clauses(dbresolver.Read)
}

func (p pmsProductVertifyRecordDo) WriteDB() *pmsProductVertifyRecordDo {
	return p.Clauses(dbresolver.Write)
}

func (p pmsProductVertifyRecordDo) Clauses(conds ...clause.Expression) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Clauses(conds...))
}

func (p pmsProductVertifyRecordDo) Returning(value interface{}, columns ...string) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Returning(value, columns...))
}

func (p pmsProductVertifyRecordDo) Not(conds ...gen.Condition) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Not(conds...))
}

func (p pmsProductVertifyRecordDo) Or(conds ...gen.Condition) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Or(conds...))
}

func (p pmsProductVertifyRecordDo) Select(conds ...field.Expr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Select(conds...))
}

func (p pmsProductVertifyRecordDo) Where(conds ...gen.Condition) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Where(conds...))
}

func (p pmsProductVertifyRecordDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *pmsProductVertifyRecordDo {
	return p.Where(field.CompareSubQuery(field.ExistsOp, nil, subquery.UnderlyingDB()))
}

func (p pmsProductVertifyRecordDo) Order(conds ...field.Expr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Order(conds...))
}

func (p pmsProductVertifyRecordDo) Distinct(cols ...field.Expr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Distinct(cols...))
}

func (p pmsProductVertifyRecordDo) Omit(cols ...field.Expr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Omit(cols...))
}

func (p pmsProductVertifyRecordDo) Join(table schema.Tabler, on ...field.Expr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Join(table, on...))
}

func (p pmsProductVertifyRecordDo) LeftJoin(table schema.Tabler, on ...field.Expr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.LeftJoin(table, on...))
}

func (p pmsProductVertifyRecordDo) RightJoin(table schema.Tabler, on ...field.Expr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.RightJoin(table, on...))
}

func (p pmsProductVertifyRecordDo) Group(cols ...field.Expr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Group(cols...))
}

func (p pmsProductVertifyRecordDo) Having(conds ...gen.Condition) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Having(conds...))
}

func (p pmsProductVertifyRecordDo) Limit(limit int) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Limit(limit))
}

func (p pmsProductVertifyRecordDo) Offset(offset int) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Offset(offset))
}

func (p pmsProductVertifyRecordDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Scopes(funcs...))
}

func (p pmsProductVertifyRecordDo) Unscoped() *pmsProductVertifyRecordDo {
...
func (p pmsProductVertifyRecordDo) Attrs(attrs ...field.AssignExpr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Attrs(attrs...))
}

func (p pmsProductVertifyRecordDo) Assign(attrs ...field.AssignExpr) *pmsProductVertifyRecordDo {
	return p.withDO(p.DO.Assign(attrs...))
}

func (p pmsProductVertifyRecordDo) Joins(fields ...field.RelationField) *pmsProductVertifyRecordDo {
...
func (p pmsProductVertifyRecordDo) Preload(fields ...field.RelationField) *pmsProductVertifyRecordDo {
	for _, _f := range fields {
