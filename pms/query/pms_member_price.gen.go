...
type pmsMemberPrice struct {
	...
	MemberPrice     field.Float64
	MemberLevelName field.String
...
func (p pmsMemberPriceDo) Debug() *pmsMemberPriceDo {
	return p.withDO(p.DO.Debug())
}

func (p pmsMemberPriceDo) WithContext(ctx context.Context) *pmsMemberPriceDo {
	return p.withDO(p.DO.WithContext(ctx))
}

func (p pmsMemberPriceDo) ReadDB() *pmsMemberPriceDo {
	return p.Clauses(dbresolver.Read)
}

func (p pmsMemberPriceDo) WriteDB() *pmsMemberPriceDo {
	return p.Clauses(dbresolver.Write)
}

func (p pmsMemberPriceDo) Clauses(conds ...clause.Expression) *pmsMemberPriceDo {
	return p.withDO(p.DO.Clauses(conds...))
}

func (p pmsMemberPriceDo) Returning(value interface{}, columns ...string) *pmsMemberPriceDo {
	return p.withDO(p.DO.Returning(value, columns...))
}

func (p pmsMemberPriceDo) Not(conds ...gen.Condition) *pmsMemberPriceDo {
	return p.withDO(p.DO.Not(conds...))
}

func (p pmsMemberPriceDo) Or(conds ...gen.Condition) *pmsMemberPriceDo {
	return p.withDO(p.DO.Or(conds...))
}

func (p pmsMemberPriceDo) Select(conds ...field.Expr) *pmsMemberPriceDo {
	return p.withDO(p.DO.Select(conds...))
}

func (p pmsMemberPriceDo) Where(conds ...gen.Condition) *pmsMemberPriceDo {
	return p.withDO(p.DO.Where(conds...))
}

func (p pmsMemberPriceDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *pmsMemberPriceDo {
	return p.Where(field.CompareSubQuery(field.ExistsOp, nil, subquery.UnderlyingDB()))
}

func (p pmsMemberPriceDo) Order(conds ...field.Expr) *pmsMemberPriceDo {
	return p.withDO(p.DO.Order(conds...))
}

func (p pmsMemberPriceDo) Distinct(cols ...field.Expr) *pmsMemberPriceDo {
	return p.withDO(p.DO.Distinct(cols...))
}

func (p pmsMemberPriceDo) Omit(cols ...field.Expr) *pmsMemberPriceDo {
	return p.withDO(p.DO.Omit(cols...))
}

func (p pmsMemberPriceDo) Join(table schema.Tabler, on ...field.Expr) *pmsMemberPriceDo {
	return p.withDO(p.DO.Join(table, on...))
}

func (p pmsMemberPriceDo) LeftJoin(table schema.Tabler, on ...field.Expr) *pmsMemberPriceDo {
	return p.withDO(p.DO.LeftJoin(table, on...))
}

func (p pmsMemberPriceDo) RightJoin(table schema.Tabler, on ...field.Expr) *pmsMemberPriceDo {
	return p.withDO(p.DO.RightJoin(table, on...))
}

func (p pmsMemberPriceDo) Group(cols ...field.Expr) *pmsMemberPriceDo {
	return p.withDO(p.DO.Group(cols...))
}

func (p pmsMemberPriceDo) Having(conds ...gen.Condition) *pmsMemberPriceDo {
	return p.withDO(p.DO.Having(conds...))
}

func (p pmsMemberPriceDo) Limit(limit int) *pmsMemberPriceDo {
	return p.withDO(p.DO.Limit(limit))
}

func (p pmsMemberPriceDo) Offset(offset int) *pmsMemberPriceDo {
	return p.withDO(p.DO.Offset(offset))
}

func (p pmsMemberPriceDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *pmsMemberPriceDo {
	return p.withDO(p.DO.Scopes(funcs...))
}

func (p pmsMemberPriceDo) Unscoped() *pmsMemberPriceDo {
...
func (p pmsMemberPriceDo) Attrs(attrs ...field.AssignExpr) *pmsMemberPriceDo {
	return p.withDO(p.DO.Attrs(attrs...))
}

func (p pmsMemberPriceDo) Assign(attrs ...field.AssignExpr) *pmsMemberPriceDo {
	return p.withDO(p.DO.Assign(attrs...))
}

func (p pmsMemberPriceDo) Joins(fields ...field.RelationField) *pmsMemberPriceDo {
...
func (p pmsMemberPriceDo) Preload(fields ...field.RelationField) *pmsMemberPriceDo {
	for _, _f := range fields {
