...
func newPmsProductCategoryAttributeRelation(db *gorm.DB) pmsProductCategoryAttributeRelation {
	_pmsProductCategoryAttributeRelation := pmsProductCategoryAttributeRelation{}

	_pmsProductCategoryAttributeRelation.pmsProductCategoryAttributeRelationDo.UseDB(db)
	...
	_pmsProductCategoryAttributeRelation.ALL = field.NewField(tableName, "*")
...
type pmsProductCategoryAttributeRelation struct {
	pmsProductCategoryAttributeRelationDo
...
func (p pmsProductCategoryAttributeRelationDo) Debug() *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Debug())
}

func (p pmsProductCategoryAttributeRelationDo) WithContext(ctx context.Context) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.WithContext(ctx))
}

func (p pmsProductCategoryAttributeRelationDo) ReadDB() *pmsProductCategoryAttributeRelationDo {
	return p.Clauses(dbresolver.Read)
}

func (p pmsProductCategoryAttributeRelationDo) WriteDB() *pmsProductCategoryAttributeRelationDo {
	return p.Clauses(dbresolver.Write)
}

func (p pmsProductCategoryAttributeRelationDo) Clauses(conds ...clause.Expression) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Clauses(conds...))
}

func (p pmsProductCategoryAttributeRelationDo) Returning(value interface{}, columns ...string) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Returning(value, columns...))
}

func (p pmsProductCategoryAttributeRelationDo) Not(conds ...gen.Condition) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Not(conds...))
}

func (p pmsProductCategoryAttributeRelationDo) Or(conds ...gen.Condition) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Or(conds...))
}

func (p pmsProductCategoryAttributeRelationDo) Select(conds ...field.Expr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Select(conds...))
}

func (p pmsProductCategoryAttributeRelationDo) Where(conds ...gen.Condition) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Where(conds...))
}

func (p pmsProductCategoryAttributeRelationDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *pmsProductCategoryAttributeRelationDo {
	return p.Where(field.CompareSubQuery(field.ExistsOp, nil, subquery.UnderlyingDB()))
}

func (p pmsProductCategoryAttributeRelationDo) Order(conds ...field.Expr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Order(conds...))
}

func (p pmsProductCategoryAttributeRelationDo) Distinct(cols ...field.Expr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Distinct(cols...))
}

func (p pmsProductCategoryAttributeRelationDo) Omit(cols ...field.Expr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Omit(cols...))
}

func (p pmsProductCategoryAttributeRelationDo) Join(table schema.Tabler, on ...field.Expr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Join(table, on...))
}

func (p pmsProductCategoryAttributeRelationDo) LeftJoin(table schema.Tabler, on ...field.Expr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.LeftJoin(table, on...))
}

func (p pmsProductCategoryAttributeRelationDo) RightJoin(table schema.Tabler, on ...field.Expr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.RightJoin(table, on...))
}

func (p pmsProductCategoryAttributeRelationDo) Group(cols ...field.Expr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Group(cols...))
}

func (p pmsProductCategoryAttributeRelationDo) Having(conds ...gen.Condition) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Having(conds...))
}

func (p pmsProductCategoryAttributeRelationDo) Limit(limit int) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Limit(limit))
}

func (p pmsProductCategoryAttributeRelationDo) Offset(offset int) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Offset(offset))
}

func (p pmsProductCategoryAttributeRelationDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Scopes(funcs...))
}

func (p pmsProductCategoryAttributeRelationDo) Unscoped() *pmsProductCategoryAttributeRelationDo {
...
func (p pmsProductCategoryAttributeRelationDo) Attrs(attrs ...field.AssignExpr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Attrs(attrs...))
}

func (p pmsProductCategoryAttributeRelationDo) Assign(attrs ...field.AssignExpr) *pmsProductCategoryAttributeRelationDo {
	return p.withDO(p.DO.Assign(attrs...))
}

func (p pmsProductCategoryAttributeRelationDo) Joins(fields ...field.RelationField) *pmsProductCategoryAttributeRelationDo {
...
func (p pmsProductCategoryAttributeRelationDo) Preload(fields ...field.RelationField) *pmsProductCategoryAttributeRelationDo {
	for _, _f := range fields {
