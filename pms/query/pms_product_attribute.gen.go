...
func newPmsProductAttribute(db *gorm.DB) pmsProductAttribute {
	_pmsProductAttribute := pmsProductAttribute{}

	_pmsProductAttribute.pmsProductAttributeDo.UseDB(db)
	...
	_pmsProductAttribute.ALL = field.NewField(tableName, "*")
...
type pmsProductAttribute struct {
	pmsProductAttributeDo

	ALL                        field.Field
	ID                         field.Int64
	ProductAttributeCategoryID field.Int64
	Name                       field.String
	SelectType                 field.Int32
	InputType                  field.Int32
	InputList                  field.String
	Sort                       field.Int32
	FilterType                 field.Int32
	SearchType                 field.Int32
	RelatedStatus              field.Int32
	HandAddStatus              field.Int32
	Type                       field.Int32
...
func (p pmsProductAttributeDo) GetProductAttrInfo(id int64) (result []*dto.PmsProductAttributeDto, err error) {
	params := make(map[string]interface{}, 0)

	var generateSQL strings.Builder
	params["id"] = id
	generateSQL.WriteString("SELECT pa.id attribute_id, pac.id attribute_category_id FROM pms_product_category_attribute_relation pcar LEFT JOIN pms_product_attribute pa ON pa.id = pcar.product_attribute_id LEFT JOIN pms_product_attribute_category pac ON pa.product_attribute_category_id = pac.id WHERE pcar.product_category_id = @id ")
...
func (p pmsProductAttributeDo) Debug() *pmsProductAttributeDo {
	return p.withDO(p.DO.Debug())
}

func (p pmsProductAttributeDo) WithContext(ctx context.Context) *pmsProductAttributeDo {
	return p.withDO(p.DO.WithContext(ctx))
}

func (p pmsProductAttributeDo) ReadDB() *pmsProductAttributeDo {
	return p.Clauses(dbresolver.Read)
}

func (p pmsProductAttributeDo) WriteDB() *pmsProductAttributeDo {
	return p.Clauses(dbresolver.Write)
}

func (p pmsProductAttributeDo) Clauses(conds ...clause.Expression) *pmsProductAttributeDo {
	return p.withDO(p.DO.Clauses(conds...))
}

func (p pmsProductAttributeDo) Returning(value interface{}, columns ...string) *pmsProductAttributeDo {
	return p.withDO(p.DO.Returning(value, columns...))
}

func (p pmsProductAttributeDo) Not(conds ...gen.Condition) *pmsProductAttributeDo {
	return p.withDO(p.DO.Not(conds...))
}

func (p pmsProductAttributeDo) Or(conds ...gen.Condition) *pmsProductAttributeDo {
	return p.withDO(p.DO.Or(conds...))
}

func (p pmsProductAttributeDo) Select(conds ...field.Expr) *pmsProductAttributeDo {
	return p.withDO(p.DO.Select(conds...))
}

func (p pmsProductAttributeDo) Where(conds ...gen.Condition) *pmsProductAttributeDo {
	return p.withDO(p.DO.Where(conds...))
}

func (p pmsProductAttributeDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *pmsProductAttributeDo {
	return p.Where(field.CompareSubQuery(field.ExistsOp, nil, subquery.UnderlyingDB()))
}

func (p pmsProductAttributeDo) Order(conds ...field.Expr) *pmsProductAttributeDo {
	return p.withDO(p.DO.Order(conds...))
}

func (p pmsProductAttributeDo) Distinct(cols ...field.Expr) *pmsProductAttributeDo {
	return p.withDO(p.DO.Distinct(cols...))
}

func (p pmsProductAttributeDo) Omit(cols ...field.Expr) *pmsProductAttributeDo {
	return p.withDO(p.DO.Omit(cols...))
}

func (p pmsProductAttributeDo) Join(table schema.Tabler, on ...field.Expr) *pmsProductAttributeDo {
	return p.withDO(p.DO.Join(table, on...))
}

func (p pmsProductAttributeDo) LeftJoin(table schema.Tabler, on ...field.Expr) *pmsProductAttributeDo {
	return p.withDO(p.DO.LeftJoin(table, on...))
}

func (p pmsProductAttributeDo) RightJoin(table schema.Tabler, on ...field.Expr) *pmsProductAttributeDo {
	return p.withDO(p.DO.RightJoin(table, on...))
}

func (p pmsProductAttributeDo) Group(cols ...field.Expr) *pmsProductAttributeDo {
	return p.withDO(p.DO.Group(cols...))
}

func (p pmsProductAttributeDo) Having(conds ...gen.Condition) *pmsProductAttributeDo {
	return p.withDO(p.DO.Having(conds...))
}

func (p pmsProductAttributeDo) Limit(limit int) *pmsProductAttributeDo {
	return p.withDO(p.DO.Limit(limit))
}

func (p pmsProductAttributeDo) Offset(offset int) *pmsProductAttributeDo {
	return p.withDO(p.DO.Offset(offset))
}

func (p pmsProductAttributeDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *pmsProductAttributeDo {
	return p.withDO(p.DO.Scopes(funcs...))
}

func (p pmsProductAttributeDo) Unscoped() *pmsProductAttributeDo {
...
func (p pmsProductAttributeDo) Attrs(attrs ...field.AssignExpr) *pmsProductAttributeDo {
	return p.withDO(p.DO.Attrs(attrs...))
}

func (p pmsProductAttributeDo) Assign(attrs ...field.AssignExpr) *pmsProductAttributeDo {
	return p.withDO(p.DO.Assign(attrs...))
}

func (p pmsProductAttributeDo) Joins(fields ...field.RelationField) *pmsProductAttributeDo {
...
func (p pmsProductAttributeDo) Preload(fields ...field.RelationField) *pmsProductAttributeDo {
	for _, _f := range fields {
