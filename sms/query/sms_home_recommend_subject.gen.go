...
func newSmsHomeRecommendSubject(db *gorm.DB) smsHomeRecommendSubject {
	_smsHomeRecommendSubject := smsHomeRecommendSubject{}

	_smsHomeRecommendSubject.smsHomeRecommendSubjectDo.UseDB(db)
	...
	_smsHomeRecommendSubject.ALL = field.NewField(tableName, "*")
...
func (s smsHomeRecommendSubjectDo) Debug() *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Debug())
}

func (s smsHomeRecommendSubjectDo) WithContext(ctx context.Context) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.WithContext(ctx))
}

func (s smsHomeRecommendSubjectDo) ReadDB() *smsHomeRecommendSubjectDo {
	return s.Clauses(dbresolver.Read)
}

func (s smsHomeRecommendSubjectDo) WriteDB() *smsHomeRecommendSubjectDo {
	return s.Clauses(dbresolver.Write)
}

func (s smsHomeRecommendSubjectDo) Clauses(conds ...clause.Expression) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Clauses(conds...))
}

func (s smsHomeRecommendSubjectDo) Returning(value interface{}, columns ...string) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Returning(value, columns...))
}

func (s smsHomeRecommendSubjectDo) Not(conds ...gen.Condition) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Not(conds...))
}

func (s smsHomeRecommendSubjectDo) Or(conds ...gen.Condition) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Or(conds...))
}

func (s smsHomeRecommendSubjectDo) Select(conds ...field.Expr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Select(conds...))
}

func (s smsHomeRecommendSubjectDo) Where(conds ...gen.Condition) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Where(conds...))
}

func (s smsHomeRecommendSubjectDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *smsHomeRecommendSubjectDo {
	return s.Where(field.CompareSubQuery(field.ExistsOp, nil, subquery.UnderlyingDB()))
}

func (s smsHomeRecommendSubjectDo) Order(conds ...field.Expr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Order(conds...))
}

func (s smsHomeRecommendSubjectDo) Distinct(cols ...field.Expr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Distinct(cols...))
}

func (s smsHomeRecommendSubjectDo) Omit(cols ...field.Expr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Omit(cols...))
}

func (s smsHomeRecommendSubjectDo) Join(table schema.Tabler, on ...field.Expr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Join(table, on...))
}

func (s smsHomeRecommendSubjectDo) LeftJoin(table schema.Tabler, on ...field.Expr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.LeftJoin(table, on...))
}

func (s smsHomeRecommendSubjectDo) RightJoin(table schema.Tabler, on ...field.Expr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.RightJoin(table, on...))
}

func (s smsHomeRecommendSubjectDo) Group(cols ...field.Expr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Group(cols...))
}

func (s smsHomeRecommendSubjectDo) Having(conds ...gen.Condition) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Having(conds...))
}

func (s smsHomeRecommendSubjectDo) Limit(limit int) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Limit(limit))
}

func (s smsHomeRecommendSubjectDo) Offset(offset int) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Offset(offset))
}

func (s smsHomeRecommendSubjectDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Scopes(funcs...))
}

func (s smsHomeRecommendSubjectDo) Unscoped() *smsHomeRecommendSubjectDo {
...
func (s smsHomeRecommendSubjectDo) Attrs(attrs ...field.AssignExpr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Attrs(attrs...))
}

func (s smsHomeRecommendSubjectDo) Assign(attrs ...field.AssignExpr) *smsHomeRecommendSubjectDo {
	return s.withDO(s.DO.Assign(attrs...))
}

func (s smsHomeRecommendSubjectDo) Joins(fields ...field.RelationField) *smsHomeRecommendSubjectDo {
...
func (s smsHomeRecommendSubjectDo) Preload(fields ...field.RelationField) *smsHomeRecommendSubjectDo {
	for _, _f := range fields {
