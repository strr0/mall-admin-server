...
func (s smsHomeBrandDo) Debug() *smsHomeBrandDo {
	return s.withDO(s.DO.Debug())
}

func (s smsHomeBrandDo) WithContext(ctx context.Context) *smsHomeBrandDo {
	return s.withDO(s.DO.WithContext(ctx))
}

func (s smsHomeBrandDo) ReadDB() *smsHomeBrandDo {
	return s.Clauses(dbresolver.Read)
}

func (s smsHomeBrandDo) WriteDB() *smsHomeBrandDo {
	return s.Clauses(dbresolver.Write)
}

func (s smsHomeBrandDo) Clauses(conds ...clause.Expression) *smsHomeBrandDo {
	return s.withDO(s.DO.Clauses(conds...))
}

func (s smsHomeBrandDo) Returning(value interface{}, columns ...string) *smsHomeBrandDo {
	return s.withDO(s.DO.Returning(value, columns...))
}

func (s smsHomeBrandDo) Not(conds ...gen.Condition) *smsHomeBrandDo {
	return s.withDO(s.DO.Not(conds...))
}

func (s smsHomeBrandDo) Or(conds ...gen.Condition) *smsHomeBrandDo {
	return s.withDO(s.DO.Or(conds...))
}

func (s smsHomeBrandDo) Select(conds ...field.Expr) *smsHomeBrandDo {
	return s.withDO(s.DO.Select(conds...))
}

func (s smsHomeBrandDo) Where(conds ...gen.Condition) *smsHomeBrandDo {
	return s.withDO(s.DO.Where(conds...))
}

func (s smsHomeBrandDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *smsHomeBrandDo {
	return s.Where(field.CompareSubQuery(field.ExistsOp, nil, subquery.UnderlyingDB()))
}

func (s smsHomeBrandDo) Order(conds ...field.Expr) *smsHomeBrandDo {
	return s.withDO(s.DO.Order(conds...))
}

func (s smsHomeBrandDo) Distinct(cols ...field.Expr) *smsHomeBrandDo {
	return s.withDO(s.DO.Distinct(cols...))
}

func (s smsHomeBrandDo) Omit(cols ...field.Expr) *smsHomeBrandDo {
	return s.withDO(s.DO.Omit(cols...))
}

func (s smsHomeBrandDo) Join(table schema.Tabler, on ...field.Expr) *smsHomeBrandDo {
	return s.withDO(s.DO.Join(table, on...))
}

func (s smsHomeBrandDo) LeftJoin(table schema.Tabler, on ...field.Expr) *smsHomeBrandDo {
	return s.withDO(s.DO.LeftJoin(table, on...))
}

func (s smsHomeBrandDo) RightJoin(table schema.Tabler, on ...field.Expr) *smsHomeBrandDo {
	return s.withDO(s.DO.RightJoin(table, on...))
}

func (s smsHomeBrandDo) Group(cols ...field.Expr) *smsHomeBrandDo {
	return s.withDO(s.DO.Group(cols...))
}

func (s smsHomeBrandDo) Having(conds ...gen.Condition) *smsHomeBrandDo {
	return s.withDO(s.DO.Having(conds...))
}

func (s smsHomeBrandDo) Limit(limit int) *smsHomeBrandDo {
	return s.withDO(s.DO.Limit(limit))
}

func (s smsHomeBrandDo) Offset(offset int) *smsHomeBrandDo {
	return s.withDO(s.DO.Offset(offset))
}

func (s smsHomeBrandDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *smsHomeBrandDo {
	return s.withDO(s.DO.Scopes(funcs...))
}

func (s smsHomeBrandDo) Unscoped() *smsHomeBrandDo {
...
func (s smsHomeBrandDo) Attrs(attrs ...field.AssignExpr) *smsHomeBrandDo {
	return s.withDO(s.DO.Attrs(attrs...))
}

func (s smsHomeBrandDo) Assign(attrs ...field.AssignExpr) *smsHomeBrandDo {
	return s.withDO(s.DO.Assign(attrs...))
}

func (s smsHomeBrandDo) Joins(fields ...field.RelationField) *smsHomeBrandDo {
...
func (s smsHomeBrandDo) Preload(fields ...field.RelationField) *smsHomeBrandDo {
	for _, _f := range fields {
